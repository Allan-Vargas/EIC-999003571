...
#1. Utilizando el conjunto de datos "airquality" calcule el grado de simetría de la variable SolarR. ¿Qué significa el valor de su simetría?
...
#2. Utilizando el conjunto de datos "airquality" ¿Cuál es la media, mediana y moda de la variable Temp?
View(airquality)
airquality
...
#5. Utilizando el conjunto de datos "airquality" indique qué desviación estándar es más adecuada. ¿La de Wind o la de Ozono?
?sd
sd(airquality$Wind)
...
#6. Utilizando el conjunto de datos "diamonds" y la librería GGPLOT y realizando el diagrama de cajas entre las variables Carat y Price indique cuál de las siguientes opciones es correcta
library(ggplot2)
...
#7. Utilizando el conjunto de datos "diamonds" y la librería GGPLOT, diagrame una gráfica de barras con la variable color. ¿Cual es el color con mayor frecuencia?
...
#8. Utilizando el conjunto de datos "diamonds" y la librería GGPLOT realice un histograma con la variable Carat en su eje X. ¿Qué tipo de simetría presenta la gráfica?
...
#10. Utilizando el conjunto de datos "diamonds" y la librería GGPLOT y realizando un diagráma de dispersión entre las variables "Y" y "Z", indique la relación entre las variables (Seleccione 2 posibles respuestas)
...
#11. Una oficina de servicio al cliente recibe en promedio 20 quejas en un día. Calcule la probabilidad de densidad y grafique sus valores. ¿Qué observa en la gráfica?
...
#12. Se ha tomado una muestra de 20 elementos, donde la probabilidad de éxito es del 60%. Calcule la probabilidad de densidad y grafique sus valores. ¿Qué tipo de sesgo se observa en los resultados?
